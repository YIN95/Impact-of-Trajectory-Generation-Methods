...
class Graph():
    ...
    def __init__(self, cfg, layout):
        self.layout = layout
        self.strategy = cfg.STGCN.STRATEGY
        self.max_hop = cfg.STGCN.MAX_HOP
        self.dilation = cfg.STGCN.DILATION
    ...
    def get_edge(self):
        if self.layout == 'openpose':
            ...
            self.edge = self_link + neighbor_link
            self.center = 2
        elif self.layout == 'congreg8-marker':
            self.num_node = 37
            self_link = [(i, i) for i in range(self.num_node)]
